...
Line 1616:   RetCode = %d
Line 1616:   RetCode = %d
Line 1634:   processBlindFreqFullScanReport: freqIndex=%d cellCtr=%d primaryScrCode=%d rscp=%d EcNo=%d deltaRscp=%d
Line 1634:   processBlindFreqFullScanReport: freqIndex=%d cellCtr=%d primaryScrCode=%d rscp=%d EcNo=%d deltaRscp=%d
Line 1638:   processBlindFreqFullScanReport: primaryScrCode=%d rscp=%ddBm EcNo=%ddB
Line 1638:   processBlindFreqFullScanReport: primaryScrCode=%d rscp=%ddBm EcNo=%ddB
Line 1660:   StoredCellSearchReqMsg == NULL pointer
Line 1660:   StoredCellSearchReqMsg == NULL pointer
Line 1687:   StoredCellSearchReqMsg send failure
Line 1687:   StoredCellSearchReqMsg send failure
Line 1701:   processBlindFreqFullScanReport: send to Stored cell search: uarfcnToProcess = %d, uarfcnIndexCtr = %d uarfcnProcessed = %d uarfcn = %d
Line 1701:   processBlindFreqFullScanReport: send to Stored cell search: uarfcnToProcess = %d, uarfcnIndexCtr = %d uarfcnProcessed = %d uarfcn = %d
Line 1711: complete: processBlindFreqFullScanReport: uarfcnToProcess = %d, uarfcnIndexCtr = %d uarfcnProcessed = %d uarfcn = %d
Line 1711: complete: processBlindFreqFullScanReport: uarfcnToProcess = %d, uarfcnIndexCtr = %d uarfcnProcessed = %d uarfcn = %d
