...
Line 392: CpichDoneCheck pathIndex=%d numOfCpichRequest=%d numOfCpichReport
Line 420: CpichDoneCheck Cell %d ScrCode=%d maxCpichIndex %d Magnitude=%d FrameOffset=%d
Line 420: CpichDoneCheck Cell %d ScrCode=%d maxCpichIndex %d Magnitude=%d FrameOffset=%d
Line 441: GroupCellSynchroniser: CpichScrCode=%d MATCHES one we are looking for PathIndex %d FrameOffset %d
Line 441: GroupCellSynchroniser: CpichScrCode=%d MATCHES one we are looking for PathIndex %d FrameOffset %d
...
Line 487: uphy_CGroupCellSynchroniser_ProcessCpichDoneCheck set gapScheduled
Line 559: GroupCellSynchroniser[%d %d]  isTxDivValid=%d, txDivStatus=%d UptodateMpAgeThreshold %d
Line 559: GroupCellSynchroniser[%d %d]  isTxDivValid=%d, txDivStatus=%d UptodateMpAgeThreshold %d
Line 573: GroupCellSynchroniser[%d] %d %d Succeeded: Up to date info found
Line 573: GroupCellSynchroniser[%d] %d %d Succeeded: Up to date info found
Line 582: GroupCellSynchroniser[%d] %d %d: MPDB reads %d paths of Age %d in subState(%d)
Line 582: GroupCellSynchroniser[%d] %d %d: MPDB reads %d paths of Age %d in subState(%d)
Line 597:  GroupCellSynchroniser[%d %d] - oldFrameOffset=%d (age %d)
Line 597:  GroupCellSynchroniser[%d %d] - oldFrameOffset=%d (age %d)
...
Line 661: GroupCellSynchroniser[%d] %d %d: Begins guided search isDeadline=%d deadline=%d
Line 680: [FA2] GroupCellSynchroniser[%d] %d %d: MPDB reads %d paths of Age %d in subState(%d)
Line 680: [FA2] GroupCellSynchroniser[%d] %d %d: MPDB reads %d paths of Age %d in subState(%d)
Line 695: [FA2] GroupCellSynchroniser[%d %d] - oldFrameOffset=%d (age %d)
Line 695: [FA2] GroupCellSynchroniser[%d %d] - oldFrameOffset=%d (age %d)
Line 702: [FA2] OLD multipath information [%d %d] Not found
Line 702: [FA2] OLD multipath information [%d %d] Not found
Line 725: [FA3] GroupCellSynchroniser[%d] %d %d: MPDB reads %d paths of Age %d in subState(%d)
Line 725: [FA3] GroupCellSynchroniser[%d] %d %d: MPDB reads %d paths of Age %d in subState(%d)
Line 740: [FA3] GroupCellSynchroniser[%d %d] - oldFrameOffset=%d (age %d)
Line 740: [FA3] GroupCellSynchroniser[%d %d] - oldFrameOffset=%d (age %d)
Line 747: [FA3] OLD multipath information [%d %d] Not found
Line 747: [FA3] OLD multipath information [%d %d] Not found
Line 764:  Wrong cellSetType:Uarfcn(%d),Psc(%d): PrimaryId=%d,SubId=%d,OldCellType %d
Line 764:  Wrong cellSetType:Uarfcn(%d),Psc(%d): PrimaryId=%d,SubId=%d,OldCellType %d
...
Line 913: Request Psch[pschAccSlotCnt=%d, postAccLen=%d, RetCode=%d]
Line 913: Request Psch[pschAccSlotCnt=%d, postAccLen=%d, RetCode=%d]
...
Line 1047:  uphy_CCellSynchroniser_processPschMeasurementReport: Wrong CellSetType
Line 1070: :	  groupCellSynchroniser Paths: pathNumber=%d pathOffset %d magnitude %d
Line 1070: :	  groupCellSynchroniser Paths: pathNumber=%d pathOffset %d magnitude %d
...
Line 1166:  processGroupCpichScrCodeMeasurementReport [%d]: pathIndex %d outstandingGroupCpichScrCodeReq %d
Line 1166:  processGroupCpichScrCodeMeasurementReport [%d]: pathIndex %d outstandingGroupCpichScrCodeReq %d
Line 1184:  processGroupCpichScrCodeMsmtReport: Wrong CellSetType
Line 1184:  processGroupCpichScrCodeMsmtReport: Wrong CellSetType
Line 1243: GroupCpichScrCode Success Result cpichScrCode[%d] ScrCode %d frameOffset[%d] %d magnitude[%d] %d
Line 1243: GroupCpichScrCode Success Result cpichScrCode[%d] ScrCode %d frameOffset[%d] %d magnitude[%d] %d
Line 1252: GroupCellSynchroniser %d pathIndex %d
Line 1252: GroupCellSynchroniser %d pathIndex %d
Line 1256: GroupCpichScrCode Fail Result PrimaryScrCode[%d]=%d does not have returned CpichScrCode =%d 
Line 1256: GroupCpichScrCode Fail Result PrimaryScrCode[%d]=%d does not have returned CpichScrCode =%d 
Line 1276:  processGroupCpichScrCodeMeasurementReport [%d %d]: UPHY_MESSAGING_RETURN_CODE_FAILURE 
Line 1276:  processGroupCpichScrCodeMeasurementReport [%d %d]: UPHY_MESSAGING_RETURN_CODE_FAILURE 
Line 1285:  GroupCpichScrCodeFail [%d]: pathIndex %d should be less than numOfCpichRequest %d
Line 1285:  GroupCpichScrCodeFail [%d]: pathIndex %d should be less than numOfCpichRequest %d
Line 1329:  uphy_CGroupCellSynchroniser_CpichMultiPathDoneMessage is NULL
Line 1360: Group CellSynchroniser %d %d: Rx Good Cpich MultiPath Msmt - Succeeded in State NoInfo
Line 1360: Group CellSynchroniser %d %d: Rx Good Cpich MultiPath Msmt - Succeeded in State NoInfo
...
Line 1423: Group Cpich MultiPath FAILED for U(%d) Psc(%d)
Line 1458:  uphy_CGroupCellSynchroniser_CheckCompletionStatus[uarfcn=%d]: RetCode !=UPHY_MESSAGING_RETURN_CODE_SUCCESS
Line 1458:  uphy_CGroupCellSynchroniser_CheckCompletionStatus[uarfcn=%d]: RetCode !=UPHY_MESSAGING_RETURN_CODE_SUCCESS
Line 1479:  When uphy_CMultiPathDatabase_SeekCellMultiPathData [% d %d] does not fail multipathInfo must not be 0
Line 1479:  When uphy_CMultiPathDatabase_SeekCellMultiPathData [% d %d] does not fail multipathInfo must not be 0
...
Line 1540: GroupCellSynchroniser %d %d: uphy_CSchedulingManager_GetCampingDlUarfcn = FALSE
Line 1557:  GroupCellSynchroniser [%d %d]: Timeout in Substate %d CampingUarfcn %d isOfflineUarfcn=%d offlineUarfcn=%d, numOfCells=%d
Line 1557:  GroupCellSynchroniser [%d %d]: Timeout in Substate %d CampingUarfcn %d isOfflineUarfcn=%d offlineUarfcn=%d, numOfCells=%d
...
Line 1662:  uphy_CGroupCellSynchroniser_CreateTimeoutToken but previous token exists - cancelling existing timeout
Line 1677: GroupCellSynchroniser %d %d: Timeout started, due to expire at=%d run at rsn = %d
Line 1677: GroupCellSynchroniser %d %d: Timeout started, due to expire at=%d run at rsn = %d
Line 1739: GroupCellSynchroniser Error : Unexpected Requestor
Line 1739: GroupCellSynchroniser Error : Unexpected Requestor
Line 1748:  replyMessage == NULL pointer
Line 1748:  replyMessage == NULL pointer
Line 1768: GroupCellSynchroniser %d : sends positive cnf to controller(Id=%d, msg=%d, SubId=%d, TransactId=%d)
Line 1768: GroupCellSynchroniser %d : sends positive cnf to controller(Id=%d, msg=%d, SubId=%d, TransactId=%d)
...
Line 1851:  cpichGroupMultiPathReqMessage == NULL pointer
Line 1887: [FA%d] GroupCpichMultipathRequest [%d] [%d %d] frameOffset=%d absDeadline=%d txDivStatus=%d
Line 1887: [FA%d] GroupCpichMultipathRequest [%d] [%d %d] frameOffset=%d absDeadline=%d txDivStatus=%d
Line 1901: [FA%d] GroupCpichMultipathRequest [%d] [%d %d] frameOffset=%d, absDeadline=%d, txDivStatus=%d
Line 1901: [FA%d] GroupCpichMultipathRequest [%d] [%d %d] frameOffset=%d, absDeadline=%d, txDivStatus=%d
...
Line 1959: SubmitGroupPschRequestSTF token %d
Line 2015:  GroupCellSynchroniser[0] %d %d: PschState_Pending SubmitPschRequest  submit token %d  to wait for signal %d value %d
Line 2015:  GroupCellSynchroniser[0] %d %d: PschState_Pending SubmitPschRequest  submit token %d  to wait for signal %d value %d
