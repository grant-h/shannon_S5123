...
Line 1274: (Periodical 0 or Triggered 1:%d)Test MeasInd, MeasId %i (-1!), UlTrChType %i, UlTrChId %i
Line 1351: (RACH 0 DCH 1 E-DCH 2 USCH 3:%d) Periodical test
Line 1393: (RACH 0 DCH 1 E-DCH 2 USCH 3:%d) MeasId %i, RbId %i, BuffPlPres %i, BuffPl %i, AveBuffPlPres %i, AveBuffPl %i,
Line 1395: ...  VarBuffPlPres %i, VarBuffPl %i
...
Line 1527: (RACH 0 DCH 1 E-DCH 2 USCH 3:%d) %x Test, Bo %i, Thresh %i, Trigger %i, PendingTime %i, TimeToTrigger %i
Line 1529: ..., ThresValid %i, PendingTimeT %i TimeToTriggerT %i
