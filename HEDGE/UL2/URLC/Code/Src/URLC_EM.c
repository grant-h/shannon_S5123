...
Line 573: UrlcReEst: RbId %d, IsRlcCheckReqd %d, DetectDlPduSize %d, DlPduSize(New)%d, DlPduSize(Old)%d SrncReloc:%d
...
Line 1043: urlc_EmCounterCheck: RbId %d, UlValid %d, DlValid %d, UL HFN %d, DL HFN %d
Line 1069: ArrayCount out of bound 
Line 1108: RbTableEntry debugging test
Line 1153: urlc_EmMaxCountC(DL): RbId %d, PduSn %d, DlActivePtr %d, HFN %d
Line 1158: urlc_EmMaxCountC(DL): RbId %d, PduSn %d, DlActiveEntry %d
Line 1208: urlc_EmMaxCountC(UL): RbId %d, UlActivationTime %d, HFN %d
Line 1235: urlc_EmMaxCountC() : CsMaxCountC %d, PsMaxCountC %d
...
Line 2025: AM Reset Pending OR SECOND LOG CH [RbId=%d, State=%d, DataSize=%d, Rep=%d, MaxPdusAv=%d, LogCh=%d, PaddingAllowed=FALSE]
Line 2067: StatusPduProcessing: RbId %d, PbDataQueuedForTxWindow %d, NumTxReq %d, NumRetxReq %d, SDU Buffer(Remaining)%d
Line 2091: !!! Reporting only CSP Buffer for RB2 which is stopped !!!
Line 2100: DataQueued(TxWinFull): RbId %d, DataSize(ReTx)%d, TimerPollExpired %d, TimerPollPeriodicExpired %d, PollForStatusRepTrigByPollProhExp %d
Line 2102:  --- [Tokens] TimerPollToken %X, TimerPollExpiredToken %X, TimerPollProhibitToken %X, PduListRoot=%X
Line 2107: DataQueued(TxWinFull): RbId %d, TimerPollExpired %d, TimerPollPeriodicExpired %d, PollForStatusRepTrigByPollProhExp %d
Line 2109:  --- [Tokens] TimerPollToken %X, TimerPollExpiredToken %X, TimerPollProhibitToken %X, PduListRoot
Line 2115: AM [RbId=%d, DataSize=%d, Rep=%d, MaxPdusAv=%d, LogCh=%d, PaddingAllowed=%d]
Line 2131: URLC State variables: RbId %d, SduBuffer %d, DataReady %d, VT_A %d, VT_S %d, VR_R %d, VR_H %d
Line 2137: URLC Statistics: [TX: SduRxed %d, PduTxed %d, ReTxed %d, StatusTxed %d], [RX: PduRxed %d, StatusRxed %d, SduCreated %d]
...
Line 2166: Err [RbId=%d, DataSize=%d, Rep=%d, MaxPdusAv=%d, LogCh=%d, PaddingAllowed=FALSE]
...
Line 2318: StatusPduProcessing: RbId %d, PbDataQueuedForTxWindow %d, NumTxReq %d, NumRetxReq %d, SDU Buffer(Remaining)%d
Line 2349: DataQueued(TxWinFull): RbId %d, DataSize(ReTx)%d, TimerPollExpired %d, TimerPollPeriodicExpired %d, PollForStatusRepTrigByPollProhExp %d
Line 2354: DataQueued(TxWinFull): RbId %d, TimerPollExpired %d, TimerPollPeriodicExpired %d, PollForStatusRepTrigByPollProhExp %d
Line 2359: AM [RbId=%d, DataSize=%d,  LogCh=%d, PaddingAllowed=%d]
Line 2374: URLC State variables : RbId %d, SduBuffer %d, DataReady %d, VT_A %d, VT_S %d, VR_R %d, VR_H %d
Line 2379: URLC Statistics : [TX: SduRxed %d, PduTxed %d, ReTxed %d, StatusTxed %d], [RX: PduRxed %d, StatusRxed %d, SduCreated %d]
...
Line 2999: URLC UL AM Statistics : RbId %d, UlByte %d, UlBlk %d, UlRetrBlk %d
Line 3016: URLC UL UM Statistics : RbId %d, UlByte %d, UlBlk %d, UlRetrBlk %d
Line 3032: URLC UL TM Statistics : RbId %d, UlByte %d, UlBlk %d, UlRetrBlk %d
...
Line 3073: URLC DL AM Statistics : RbId %d, DlByte %d, DlBlk %d, DlRetrBlk %d
Line 3090: URLC DL UM Statistics : RbId %d, DlByte %d, DlBlk %d, DlRetrBlk %d
Line 3106: URLC DL TM Statistics : RbId %d, DlByte %d, DlBlk %d, DlRetrBlk %d
