...
Line 164: BitOffset of Status PDU is not vaild(SUFI_LIST): RbId %d, BitOffset %d, ReportSize %d
...
Line 264: PDU Segmentation can start II(by StatusReport): RbId %d, VT_A %d, VT_S %d
...
Line 371: urlc_IspStatusStateInvokedReturnFunc() : RbId %d, DataSize %d, NumTxReq %d, NumRetxReq %d, SDU Buffer(Remaining)%d
Line 410: BitOffset of Status PDU is not vaild(RLIST): RbId %d, BitOffset %d, ReportSize %d
Line 414: RLIST_SUFI:
Line 424: RX SUFI_RLIST: RbId %d, FSN = %d, LENGTH = %d
Line 438: Invalid/Inconsistent
Line 452: BitOffset of Status PDU is not vaild(RLIST): RbId %d, BitOffset %d, ReportSize %d
Line 470: Status PDU is not vaild(RLIST), Error Burst: RbId %d, RListLength %d, RListData %d
Line 482: Status PDU is not vaild(RLIST): RbId %d, RListLength %d, RListData %d
Line 493: Invalid/Inconsistent
Line 523: BitOffset of Status PDU is not vaild(MRW): RbId %d, BitOffset %d, ReportSize %d
Line 530:  SUFI_MRW: MRW Length = %d
Line 538:  MRW SN = %d
Line 548: BitOffset of Status PDU is not vaild(MRW): RbId %d, BitOffset %d, ReportSize %d
Line 556:  MRW SN = %d
Line 562: BitOffset of Status PDU is not vaild(MRW): RbId %d, BitOffset %d, ReportSize %d
Line 570:  NLength = %d
Line 597: BitOffset of Status PDU is not vaild(MRW_ACK): RbId %d, BitOffset %d, ReportSize %d
Line 610:  SUFI_MRW_ACK: NLength = %d SN_Ack = %d
Line 638: BitOffset of Status PDU is not vaild(POLL): RbId %d, BitOffset %d, ReportSize %d
...
Line 751: RLIST_SUFI(Invalid)OutWin: RbId %d, RListSn %d, VT_A %d, VT_S(-1):%d, InvalidStatusPduCnt %d
Line 796: RLIST_SUFI(Invalid)OutWin: RbId %d, RListSn %d, VT_A %d, VT_S(-1):%d, InvalidStatusPduCnt %d
Line 845: BitOffset of Status PDU is not vaild(ACK): RbId %d, BitOffset %d, ReportSize %d
Line 852: RX SUFI_ACK: RbId = %d, LSN = %d
Line 867:  ACK_SUFI(In window,Ignored): RbId %d, VT_A %d, VT_S %d, LowerEdge %d, AckLsn %d, InvalidStatusPduCnt %d
Line 881:  ACK_SUFI(out window):RbId %d, VT_A %d, VT_S %d, LowerEdge %d, AckLsn %d 
Line 890:  ACK_SUFI WaitMrwAckSufi is TRUE(Ignore): RbId %d, VT_A %d, VT_S %d, AckLsn %d 
Line 919:  ACK_SUFI(Inconsistent): RbId %d, PduSn %d
Line 966: BitOffset of Status PDU is not vaild(LIST): RbId %d, BitOffset %d, ReportSize %d
...
Line 1064: BitOffset of Status PDU is not vaild(BITMAP): RbId %d, BitOffset %d, ReportSize %d
Line 1091:  Invalid bitmap Sufi: RbId %d, FSN %d, VT_A %d, VT_S %d
Line 1102: BitOffset of Status PDU is not vaild(BITMAP): RbId %d, BitOffset %d, ReportSize %d
Line 1110: RX SUFI_BITMAP: RbId %d, Length %d, FSN %d, Byte %X, ReportedLastSn %d, VT_A %d, VT_S %d
Line 1123:  SUFI_BITMAP(Invalid)OutWin: RbId %d, PduSn %d, VT_A %d, VT_S:%d, InvalidStatusPduCnt %d
...
Line 1177: BitOffset of Status PDU is not vaild(BITMAP): RbId %d, BitOffset %d, ReportSize %d
Line 1184: SUFI_BITMAP: RbId %d, Length %d, FSN %d, Byte %X, ReportedLastSn %d, VT_A %d, VT_S %d
...
Line 1279: BitOffset of Status PDU is not vaild(WINDOW): RbId %d, BitOffset %d, ReportSize %d
