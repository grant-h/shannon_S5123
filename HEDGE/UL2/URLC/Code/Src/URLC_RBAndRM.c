...
Line 371: ListNextEntry is NULL: PduSnBot %d, PduSnTop %d, Type %d, LiNum %d
Line 477: Critical SRB reception[%d]: Requesting turn OFF protection: Guard timer %x, SN in timer %d, PduSnBot %d, PriorityDuration %d
...
Line 663: urlc_RbrmMaintainStateVars: RbId %d, HFN Inc Exceptional case(Warp around but No HFN Increment< SN %d,  VR_US=%d(BF update)
Line 674: urlc_RbrmMaintainStateVars: RbId %d, Sn %d, VR_US %d
Line 692: Critical SRB reception[%d]: Guard Timer was still active, Send token to PHY: RbrmVars->Guard_Timer %x, PduSn %d 
...
Line 798: urlc_RbrmPassToReceptBuff() : RbId %d, VR_US %d, PduSn(F)%d, PduSn(L)%d, NumPdus %d
Line 850: Discard UM Data(Duplicated): RbId %d, NumPdus %d, VR_US %d, PduSn %d
Line 882: UM mode. Not equal to VR_US!: RbId %d, VR_US %d, PduSn %d
Line 894: urlc_RbrmPassToReceptBuff(): RbId %d, VR_R %d, VR_H %d, PduSn(F)%d, PduSn(L)%d, NumPdus %d, PduSize(F) %d
Line 917: RxWinFull RbId=%d, SN=%d, num=%d, VR_R=%d, VR_H=%d, WinTop=%d, 
Line 981: urlc_RbrmMrwStf RbId = %d unsafe to process token
Line 985: urlc_RbrmMrwStf RbId = %d SnLength = %d NLength = %d
Line 1005: urlc_RbrmMrwStf RbId = %d ListEntry LI %d [%d %d] type %d data %x
...
Line 1294: Current segment (sn [%d %d] li %d first %d last %d) shouldn't be combined with trim marker
...
Line 1498: ProcessSduSegment: special case discard: RbId %d, PduSn %d, Data %d, First %d, Last %d skipping it since it doesn't have start marker
...
Line 1679: Critical SRB reception: MessageType %d, PduSn %d, PduSnBot %d, LastSeg %d, Guard Timer %x PendingPDUSn %d
Line 1703: Critical SRB reception[%d]: Deleting Guard timer %x, SN in timer %d, PduSnBot %d, PriorityDuration %d
Line 1712: Critical SRB reception: Higher Req reason: Pending SN %d, MsgType %d, VR_R %d, VR_H %d
Line 1728: Critical SRB reception: Cant decide abt RLC protection, TURN ON TFCI protection: PduSnBot %d, PduSnTop %d, VR_R %d, VR_H %d
Line 1820: LI_CHECK() : NumLis=%d
Line 1830: LI_CHECK() : RbId=%d, PduSn %d, %dth, LiSize=%d, LI value=0x%x PDUPosOffset=%d PDUsize= %d
...
Line 1999: PDU with SN:%d received with HE(1%d) on RbId:%d
...
Line 2255: Critical SRB reception [%d]: Requesting turn OFF protection: Guard Timer %x, SN %d discarded, SN in timer %d, PriorityDuration %d
...
Line 2305: urlc_RbrmProcDecodePdu() : RbId %d, UM, AlternativeEbit TRUE SduSize %d, PaySrc 0x%x, RlcH %x
Line 2317: urlc_RbrmProcDecodePdu(): Discarding LI due to MRW: RbId=%d, PduSn %d, NumLis %d, LiDisLimit %d, LiOffset %d
Line 2341: ###### urlc_RbrmProcDecodePdu() : RbId=%d, PduSn %d, LI count=%d, LiSize=%d, LI value=0x%x
Line 2372: RbId=%d : SN=%d, (%dth/Tot:%d) LI = 0x7FFB recieved in first PDU
Line 2385: RbId=%d : SN=%d, (%dth/Tot:%d) LI = 0x7FFB
Line 2398: Error deteced: RbId=%d : SN=%d, (%dth/Tot:%d), LI = 0x7FFC invalid LI received for mode %d
Line 2431: Error detected: invalid condition for LI 0x7FFA, Mode: %d, AlternativeEbit: %d, LiSize: %d
Line 2434: Error detected: invalid condition for LI 0x7FFA, Mode: %d, LiSize: %d
Line 2455: Error detected: invalid condition for LI 0x7FFD, Mode: %d, AlternativeEbit: %d
Line 2458: Error detected: invalid condition for LI 0x7FFD, Mode: %d
Line 2484: Error detected: SduPortion is NULL.
Line 2510: DecodePDU : RbId=%d, SN=%d  LI count=%d, LiSize=%d, LI value=0x%x:8bits remained on LISize=15
...
Line 2560: UM SDU delivery(AlternativeEbit) or 0x7ffd: RbId %d, PduSn %d, PaySrc 0x%x
...
Line 2788: WARNING: PDU Size 0, discard (RbId=%d)
