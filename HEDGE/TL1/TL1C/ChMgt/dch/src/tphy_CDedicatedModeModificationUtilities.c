...
Line 921: DCH: DL_TRCH_ADD, cctrchNr = %d, nTrchs = %d, trChBitStream = %x 
Line 933: DCH: DL_TRCH_ADD, Corrupt DlTrCh
Line 947: DCH: DL_TRCH_ADD, Can't locate Dedicated CcTrCh
Line 971: DCH: DL_TRCH_ADD, cctrchNr = %d nTrchs = %d trChBitStream = %x
Line 994: DCH: DL_TRCH_ADD, Moved THAL TrCh = %d to %d for URRC TrCh Id = %d to make room for new transport channels
Line 1058: DCH: DL_TRCH_ADD, Add THAL TrCh = %d for URRC TrCh Id = %d
Line 1091: DCH: DL_TRCH_ADD, AMR targetBler changed if targetBler > 1.0 and rateMachingArgument > 180
Line 1095: DCH: DL_TRCH_ADD, AMR targetBler not changed
Line 1133: DCH: DL_TRCH_ADD, Moved THAL TrCh = %d to %d for URRC TrCh Id = %d to make room for new transport channels
...
Line 1852: UarfcnCmd exec failure, errCode = %d, addErrCode = %d
...
Line 2467: ModifyRlReq(), TDM configured RepPeriod = %d, RepLength = %d,OffSet = %d,TdmActTime  =%d
Line 2486: IsBatonHO %d  N-Freq Change Implementation 
Line 2488: tphy_CDedicatedModeController_processModifyRlReq: isNfreqConfig =%d, uarfcn = %08d
...
Line 2545: tphy_CDedicatedModeController_processModifyRlReq: SEC FREQ PRESENT isNfreqConfig =%d, message->payload.rlInfo.SecondaryFreq = %08d
Line 2550: ETHalRfRxUarfcnCmd - thal_CCmd_exec FAILED
Line 2570: tphy_CDedicatedModeController_processModifyRlReq: isNfreqConfig =%d
Line 2587: ETHalRfRxUarfcnCmd - thal_CCmd_exec FAILED
Line 2603: tphy_CDedicatedModeModificationUtilities_processModifyRlReq: N Freq Release 
Line 2617: ETHalRfRxUarfcnCmd - thal_CCmd_exec FAILED
Line 2660: sfnSfnDiff = %d, SfnToSfn_FailedConfiguration = %d, Current RSN = %d, dedicatedModeModificationUtilities_ptr = %d, msg = %d
Line 2667: rlStartCommand thal command exec failed: Err Code %d AddErrCode %d
Line 2726: tphy_CDedicatedModeModificationUtilities_SendConfirmSTF(): msg is worng!!!!
Line 2731: tphy_CDedicatedModeModificationUtilities_SendConfirmSTF Current RSN = %d, msg = %d, dedicatedModeModificationUtilities_ptr = %d
