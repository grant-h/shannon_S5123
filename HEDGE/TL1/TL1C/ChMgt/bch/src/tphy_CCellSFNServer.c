...
Line 326: Received CellSFNServer message (ECellSfnServerMsgId_XXX) = %d from source = %d
...
Line 406: CellSfnServer: State - Init, UARFCN = %d, midambleIdx = %d, eventId = %d
...
Line 456: CellSfnServer: UARFCN =%d, midambleIdx =%d, Begins servicing request at CFN = %d
Line 459: CellSfnServer: RL does not already exist - no ref cell in mpdb
Line 465: CellSfnServer: UARFCN =%d, midambleIdx =%d, Begins servicing request at CFN = %d
Line 469: CellSfnServer:  RL does not already exist - ref cell in mpdb, UARFCN = %d, pScrCode = %d
...
Line 514: ETphyCellSFNServerEventId_BchReleaseDone in Init state: Event TransactId=%d SFN TransactId=%d
...
Line 611: ETphyCellSFNServerEventId_BchReleaseDone in BchReleaseRequested state: Event TransactId=%d SFN TransactId=%d
Line 619: Invalid event! Has there been a releaseAll ?
Line 626: ETphyCellSFNServerEventId_BchReleaseDone in bchConfigurationRequested state: Event TransactId=%d SFN TransactId=%d
...
Line 684: CellSfnServer [%d %d] - Timeout in bchConfigDone state: this->currentSfnReqMsg->header.TransactId=%d
Line 704: Invalid event! has there been a releaseAll ?
Line 723: ETphyCellSFNServerEventId_BchReleaseDone in bchConfigDone state: Event TransactId=%d SFN TransactId=%d
...
Line 813: ETphyCellSFNServerEventId_BchReleaseDone in BchReleaseRequested state: Event TransactId=%d SFN TransactId=%d
...
Line 1087: tphy_CCellSfnServer[%d,%d] GetSfnAndSendReleaseRequest: referenceSfn: %d, referenceCfn: %d, targetSfn %d
Line 1100: Set SMC SFN and CFN: Old SFN %d New SFN %d New CFN %d
...
Line 1490: CellSfnServer[%d,%d] Cell Sfn Server rejects dud data at framework SFN %d, chipset [radio link %d]
Line 1507: CellSfnServer[%d,%d] Cell Sfn Server accepts good data with sfn %d at framework SFN %d, chipset [radio link %d] sfn %d
Line 1514: CellSfnServer[%d,%d] Cell Sfn Server accepts good data cont- trChinfo->chipOffset %d
Line 1536: msg == NULL pointer
Line 1555: CellSfnServer[%d,%d]SendSfnIndMessage
Line 1561: CellSfn negative ind msg: DestId=%d, TransactId=%d
...
Line 1650: UserPlaneCallback TrCH ID %d SFN %d referenceRlSfn %d crc %d
