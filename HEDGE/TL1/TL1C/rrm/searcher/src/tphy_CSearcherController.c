Line 514: Srch Ctrl :releaseMidCellSynchroniser: Free CellSynchroniser[%d] Uarfcn[%d] Midamble[%d]  cellSynchroniserId=%d nCellSynchronisers=%d
...
Line 753: ICS RequestReason changed to SysInfo during BPLMN: tdd_isBPLMN=%d, tdd_isBPLMN_Search_From_OtherRAT=%d
...
Line 1122: Srch Ctrl :process: msgId=%d, srcPrimaryId=%d, srcSubId=%d, TransactId=%d
...
Line 2063: Srch Ctrl :notifyStoredCompleted: FREE StoredCellSearcherer[%d] StoredCellSearcherId=%d nInitialCellSearchers=%d
...
Line 2332: IntraGCS: Midamble= %d TotalRscp= %d UpdateCnt=%d avgRscp=%d
Line 2351: Intra Freq GCS: Dominant Midamble= %d RSCP =%d
Line 2406: Srch Ctrl :ReleaseInterGroupCellSynchro
Line 2428: Inter Freq GCS: Midamble= %d TotalRscp= %d ucUpdateCnt=%d avgRscp=%d
Line 2447: Inter Freq GCS: Dominant Midamble= %d RSCP =%d
...
Line 4496: tphy_CSearcherController_processFreqCellSearchRequest: found cell (%d, %d), rscp=%d, delta_rscp=%d
...
Line 5213: Srch Ctrl: processMultipathMeasurementReport : MP_mode=[%d] 
