...
Line 150: phy_ts1[0] 0x%x phy_ts1[1] 0x%x
Line 155: phy_ts2[0] 0x%x phy_ts2[1] 0x%x
Line 160: phy_ts3[0] 0x%x phy_ts3[1] 0x%x
Line 165: phy_ts4[0] 0x%x phy_ts4[1] 0x%x
Line 170: phy_ts5[0] 0x%x phy_ts5[1] 0x%x
Line 175: phy_ts6[0] 0x%x phy_ts6[1] 0x%x
...
Line 1491: Rcvd Sign %d Sent Sign %d SentSubFrm %d CurrSubFrm %d RelSubFrm %d
...
Line 1639: fpachHISR: configureUlPhyCh(), UlPhychConfigCmd exec failed - Err Code = %d, Addl Err Code = %d
...
Line 1996: fpachHISR: configureUlPhyCh(), UlPhychConfigCmd exec failed - Err Code = %d, Addl Err Code = %d
