...
Line 1311: [CONTROLCHANNEL] rabm_CsSetDataType() : RabId %01X, CallSessionNumber %d, SyncStatus %d, DataType : %d)
...
Line 1727: [CS_UPLINK] rabm_CsUlSendData: queuedBits: %d, DlDataSent: %d, SubFlowID : %d, RabId %d RbId %d
...
Line 2271: [INTERNAL_CHANNEL] Rabm_FindNsapiIPv6 : Primary Nsapi (%01X),  SID (%d) TFT (%d) 
Line 2278: [INTERNAL_CHANNEL] Rabm_FindNsapiIPv6 : Primary Nsapi (%01X),  SID (%d)  TFT (%d) 
Line 2305: [INTERNAL_CHANNEL] Rabm_FindNsapiIPv6 : NSAPI %d, TFT idx %d, iFind %d, higer_precedence_value %d, precedence_value %d
