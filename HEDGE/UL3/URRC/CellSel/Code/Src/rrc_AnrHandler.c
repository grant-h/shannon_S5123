...
Line 235: [URRC_ANR]: init: ANRHandler initialization problem - couldn't register with MM boundary
Line 241: [URRC_ANR]: init: ANRHandler initialization - MM_URRC_PREPARE_CGI_REQ register with MM boundary
Line 249: [URRC_ANR]: init: ANRHandler initialization problem - couldn't register with MM boundary InstanceId = %d, MsgId = %d, FuncPtr = %d
Line 255: [URRC_ANR]: init: ANRHandler initialization - MM_URRC_START_CGI_REQ register with MM boundary InstanceId = %d, MsgId = %d, FuncPtr = %d
Line 263: [URRC_ANR]: init: ANRHandler initialization problem - couldn't register with MM boundary InstanceId = %d, MsgId = %d, FuncPtr = %d
Line 269: [URRC_ANR]: init: ANRHandler initialization - MM_URRC_CGI_STOP_REQ register with MM boundary InstanceId = %d, MsgId = %d, FuncPtr = %d
Line 277: [URRC BCH in DCH]: init: ANRHandler initialization problem - couldn't register with UPHY boundary InstanceId = %d, MsgId = %d, FuncPtr = %d
Line 283: [URRC BCH in DCH]: init: ANRHandler initialization - CUPHY_REFERENCE_CELL_IND register with UPHY boundary InstanceId = %d, MsgId = %d, FuncPtr = %d
Line 290: [URRC BCH in DCH]: init: ANRHandler initialization problem - couldn't register with UPHY boundary InstanceId = %d, MsgId = %d, FuncPtr = %d
Line 296: [URRC BCH in DCH]: init: ANRHandler initialization - CUPHY_REFERENCE_CELL_IND register with UPHY boundary InstanceId = %d, MsgId = %d, FuncPtr = %d
Line 306: ERROR registering for State Change notificationwith CnxMgr
Line 314: [URRC_ANR]: init: ANRHandler initialization problem - couldn't register with MM boundary InstanceId = %d, MsgId = %d, FuncPtr = %d
Line 320: [URRC_ANR]: init: ANRHandler initialization - MM_URRC_CGI_ACQUISITION_REQ register with MM boundary InstanceId = %d, MsgId = %d, FuncPtr = %d
...
Line 563: [URRC_ANR]: Scheduling info at MIB for SIB1(%d) SIB3(%d)
...
Line 1140: [URRC_ANR]: NotActive_PrepareCgiInd AnrHandler_p->is_fdd_mode set to (%d)
Line 1148: [URRC_ANR]: ANR is not support for (%d) umts_access_mode 
Line 1155: [URRC_ANR]: NotActive_PrepareCgiInd AnrHandler_p->si_requestForHO set to TRUE(%d)
...
Line 1544: [URRC_ANR]: AwaitingAnrInfo_ReceivedMsg unexpected msg (%x) ignored
...
Line 1692: [URRC_ANR]:rrc_AnrHandler : SendCgiAcqCnf - Fatal Error AnrHandler_p->UtraSiAcqForHoMode(%d) AnrHandler_p->CgiAcqCnf.UtraSiAcquisitionForHoMode(%d)
Line 1703: [URRC_ANR]:rrc_AnrHandler : SendCgiAcqCnf - successful case of AnrHandler_p->UtraSiAcqForHoMode(%d)
Line 1725: [URRC_ANR]:rrc_AnrHandler : SendCgiAcqCnf - invalid slot(%d) value
Line 1734: [URRC_ANR]:rrc_AnrHandler : SendCgiAcqCnf - invalid chip(%d) value
Line 1743: [URRC_ANR]:rrc_AnrHandler : SendCgiAcqCnf - invalid duration_margin(%d) value will be set to 3 (30ms) forcefully
Line 1791: [URRC_ANR]MIB_GAP_INFO AbsoluteModemTiming : (CurrentSfn(%d frame) + CurrAbsoluteAfn(%d frame) + SfnGap(%d frame) - Duration_Margin(%d frame)) mod MAX_SFN(4096) = NextTimeAbsoluteAfn(%d frame)
Line 1796: [URRC_ANR]MIB_GAP_INFO Umtstiming : (CurrentSfn(%d frame) + SfnGap(%d frame) - Duration_Margin(%d frame)) mod MAX_SFN(4096) = CurrrentSFNForNextMode(%d frame)
Line 1799: [URRC_ANR]MIB_GAP_INFO: duration_margin.sfn(%d frame) * 10 + UTRAN_CGI_MIB_DECODING_GAP_DEFAULT_FDD(20ms) = requiredGapDuration(%d ms)
Line 1801: [URRC_ANR]MIB_GAP_INFO: UmtsRepetitionPeriodForNextMode(%d) = FDD_MIB_REPETITION_PERIOD_DEFAULT(8 frame) * 10ms
Line 1822: [URRC_ANR]:rrc_AnrHandler : SendCgiAcqCnf - Sib1 SchedInfo SEG_COUNT(%d) SIB_REP(%d) SIB_POS(%d) SIB_OFF(%d)
Line 1828: [URRC_ANR]:rrc_AnrHandler : SendCgiAcqCnf - Sib3 SchedInfo SEG_COUNT(%d) SIB_REP(%d) SIB_POS(%d) SIB_OFF(%d)
Line 1834: [URRC_ANR]:rrc_AnrHandler : SendCgiAcqCnf - invalid duration_margin(%d) value will be set to 3 (30ms) forcefully
Line 1923: [URRC_ANR]SIB1_GAP_INFO SfnGap = SIB_REP(%d) - (currrent_sfn(%d) mod SIB_REP(%d)) + SIB_POS(%d) = %d
Line 1929: [URRC_ANR]SIB1_GAP_INFO AbsoluteModemTiming : (CurrentSfn(%d frame) + CurrAbsoluteAfn(%d frame) + SfnGap(%d frame) - Duration_Margin(%d frame)) mod MAX_SFN(4096) = NextTimeAbsoluteAfn(%d frame)
Line 1934: [URRC_ANR]SIB1_GAP_INFO Umtstiming : (CurrentSfn(%d frame) + SfnGap(%d frame) - Duration_Margin(%d frame)) mod MAX_SFN(4096) = CurrrentSFNForNextMode(%d frame)
Line 1937: [URRC_ANR]SIB1_GAP_INFO: duration_margin.sfn(%d frame) * 10 + UTRAN_CGI_SIB1_DECODING_GAP_DEFAULT_FDD(20ms) = requiredGapDuration(%d ms)
Line 1940: [URRC_ANR]SIB1_GAP_INFO: UmtsRepetitionPeriodForNextMode(%d) = Sib1_RepPeriod(%d) * 10ms
Line 1948: [URRC_ANR]SIB3_GAP_INFO SfnGap = SIB_REP(%d) - (currrent_sfn(%d) mod SIB_REP(%d)) + SIB_POS(%d) = %d
Line 1954: [URRC_ANR]SIB3_GAP_INFO AbsoluteModemTiming : (CurrentSfn(%d frame) + CurrAbsoluteAfn(%d frame) + SfnGap(%d frame) - Duration_Margin(%d frame)) mod MAX_SFN(4096) = NextTimeAbsoluteAfn(%d frame)
Line 1959: [URRC_ANR]SIB3_GAP_INFO Umtstiming : (CurrentSfn(%d frame) + SfnGap(%d frame) - Duration_Margin(%d frame)) mod MAX_SFN(4096) = CurrrentSFNForNextMode(%d frame)
Line 1962: [URRC_ANR]SIB3_GAP_INFO: duration_margin.sfn(%d frame) * 10 + UTRAN_CGI_SIB3_DECODING_GAP_DEFAULT_FDD(20ms) = requiredGapDuration(%d ms)
Line 1965: [URRC_ANR]SIB3_GAP_INFO: UmtsRepetitionPeriodForNextMode(%d) = Sib3_RepPeriod(%d) * 10ms
Line 1974: [URRC_ANR]: Fatal Error SendCgiAcqCnf - SIB3 scheduling information is not included in this cell
Line 1986: [URRC_ANR]:rrc_AnrHandler : SendCgiAcqCnf - SIB3 has been decoded successfully return AnrHandler_p->CgiAcqCnf.isSuccess %d
Line 1994: [URRC_ANR]:rrc_AnrHandler : SendCgiAcqCnf - FatalError Unknown UtraSiAcqForHoMode(%d)
Line 2003: [URRC_ANR]:rrc_AnrHandler : SendCgiAcqCnf - un-successful case of AnrHandler_p->UtraSiAcqForHoMode(%d)
Line 2029: [URRC_ANR]:rrc_AnrHandler : SendCgiAcqCnf - FatalError Unknown UtraSiAcqForHoMode(%d)
...
Line 2276: [URRC_ANR]: Unknown Mode detected MsgPtr->UtraSiAcquisitionForHoMode(%d)
Line 2282: [URRC_ANR]: Wrong AnrHandler_p->UtraSiAcqForHoMode(%d) is given in Ready state with AnrHandler_p->si_requestForHO(%d)
...
Line 2361: [URRC_ANR]: MsgPtr->UtraSiAcquisitionForHoMode(%d) is being sent. Current AnrHandler_p->UtraSiAcqForHoMode is (%d)
...
Line 2430: [URRC_ANR]: Unknown Mode detected MsgPtr->UtraSiAcquisitionForHoMode(%d)
...
Line 2505: [URRC_ANR]: AnrHandler_p->CgiAcqCnf.UmtsTimingForNextMode[%d].sfn (%d)
Line 2507: [URRC_ANR]: AnrHandler_p->CgiAcqCnf.UmtsTimingForNextMode[%d].slot (%d)
Line 2509: [URRC_ANR]: AnrHandler_p->CgiAcqCnf.UmtsTimingForNextMode[%d].chip (%d)
Line 2511: [URRC_ANR]: AnrHandler_p->CgiAcqCnf.UmtsTimingForNextMode[%d].refCounterFrame (%d)
Line 2513: [URRC_ANR]: AnrHandler_p->CgiAcqCnf.UmtsTimingForNextMode[%d].refCounterSlot
Line 2515: [URRC_ANR]: AnrHandler_p->CgiAcqCnf.UmtsTimingForNextMode[%d].refCounterChip (%d)
Line 2517: [URRC_ANR]: AnrHandler_p->CgiAcqCnf.requiredGapDuration[%d] (%d)
Line 2519: [URRC_ANR]: AnrHandler_p->CgiAcqCnf.UmtsRepetitionPeriodForNextMode[%d] (%d)
...
Line 2766: [URRC_ANR]: WaitingforConfirmation_AwaitingAnrInfoReadAborted AnrHandler_p->si_requestForHO(%d)
...
Line 2829: [URRC BCH in DCH] PLMN(%x%x%x%x%x%x)
...
Line 3026: [URRC_ANR]: Received CUPHY_UMTS_RAT_MODE_CNF from UPHY when AnrHandler_p->UtraSiAcqForHoMode has %d value
...
Line 3486: [URRC_ANR]: CUPHY_CGI_ACQUISITION_RELEASE_CNF received
Line 3499: [URRC_ANR]: CUPHY_SFN_ACQUISITION_CONFIG_CNF received moved to AwaitingAnrInfo state for getting CUPHY_SFN_ACQUISTION_IND
Line 3503: [URRC_ANR]: ERROR Illegal State in Ready_MmCgiTimeInd
Line 3509: [URRC_ANR]: Fatal Error invalid mode AnrHandler_p->si_requestForHO(%d) AnrHandler_p->SiAcqUphyCnfMode(%d)
...
Line 3620: [URRC BCH in DCH] PLMN(%x%x%x%x%x%x)
...
Line 3797: [URRC BCH in DCH] PLMN(%x%x%x%x%x%x)
...
Line 4059: ANR : Added currently selected PlmnId: 0x%02X, 0x%02X, 0x%02X  to head of the list
Line 4088: ANR : Added currently selected PlmnId: 0x%02X, 0x%02X, 0x%02X  to head of the list
Line 4278: [URRC_ANR]: Timer TDRX or Scan stopped in AwaitingAnrInfo_AwaitingAnrInfoReadSuccesss
Line 4290: [URRC_ANR]: AwaitingAnrInfo_AwaitingAnrInfoReadSuccesss AnrHandler_p->UtraSiAcqForHoMode(%d)
...
Line 4378: [URRC_ANR]: AwaitingAnrInfo_AwaitingAnrInfoReadFailure AnrHandler_p->UtraSiAcqForHoMode(%d)
...
Line 4505: [URRC_ANR]: WaitingforConfirmation_AwaitingAnrInfoReadAborted AnrHandler_p->si_requestForHO(%d)
...
Line 4650: [URRC_ANR]: AwaitingAnrInfo_ReceivedMsg unexpected msg (%x) ignored
Line 4775: [URRC BCH in DCH] Uarfcn = %d, PSC = %d, CellId 0x%x, Lac = %d, Rac = %d is added to DB
