...
Line 347: rrc_ServingCellSysInfoCache_InitLastNeighborFreq: (Uarfcn = %d) Restored to LastUsedNeighborFreq[%d]
Line 355: rrc_ServingCellSysInfoCache_InitLastNeighborFreq: %d freq restored
Line 371: remove the oldest SCellSysInfo (Uarfcn = %d, Cpich = %d)
...
Line 583: rrc_ServingCellSysInfoCache_AddNewFreqToLastUsedNeighborFreq : UARFCN(%d), Current NumLastUsedNFreqInfo(%d) 
...
Line 679: Fatal Error: SameCellInfo is not found at SCellSysInfoCache(%d) from ServingCellSysInfoCache_p->NumSCellInfo(%d)
Line 680: Fatal Error: SibType(%d) cannot be copied to SCellSysInfoCache
Line 729: PeerSimCache[%d] : Found LastServingCellInfo[%d] for UARFCN%i/PSC%i (NumSCellInfo %i)
Line 782: Found LastServingCellInfo[%d] for UARFCN%i/PSC%i (NumSCellInfo %i)
Line 788: Deleting LastServingCellInfo[%d] entry for UARFCN%i/PSC%i, as it does not contain complete SIBs
Line 795: No LastServingCellInfo Found for UARFCN%i/PSC%i (NumSCellInfo %i)
Line 799: No LastServingCellInfo Available(%d)
Line 832: Finding SibId[%i] for (UARFCN%i/PSC%i) from LastSCellInfo (Total %i Cell Info Saved)
Line 840: Finding SibId[%i] for (UARFCN%i/PSC%i) from LastSCellInfo (Total %i Cell Info Saved)
...
Line 901: rrc_ServingCellSysInfoCache_GetScellInfoIdxForHcsPriorityInfo : HcsPrioInfo found at Idx(%d) ServUarfcn(%d) ServCpich(%d) ServHcsPrio(%d)
Line 918: rrc_ServingCellSysInfoCache_GetScellInfoIdxForHcsPriorityInfo : HcsPrioInfo found at Idx(%d) NeibUarfcn(%d) NeibCpich(%d) NeibHcsPrio(%d)
Line 943: rrc_ServingCellSysInfoCache_GetScellInfoIdxForHcsPriorityInfo : HcsPrioInfo found at Idx(%d) NeibUarfcn(%d) NeibCpich(%d) NeibHcsPrio(%d)
...
Line 989: rrc_ServingCellSysInfoCache_GetScellInfoIdxForHcsPriorityInfo : HcsPrioInfo found at Idx(%d) ServUarfcn(%d) ServCpich(%d) ServHcsPrio(%d)
Line 1005: rrc_ServingCellSysInfoCache_GetScellInfoIdxForHcsPriorityInfo : HcsPrioInfo found at Idx(%d) NeibUarfcn(%d) NeibCpich(%d) NeibHcsPrio(%d)
Line 1026: rrc_ServingCellSysInfoCache_GetScellInfoIdxForHcsPriorityInfo : HcsPrioInfo found at Idx(%d) NeibUarfcn(%d) NeibCpich(%d) NeibHcsPrio(%d)
...
Line 1072: rrc_ServingCellSysInfoCache_CopyHcsPriorityInfo : ServUarfcn(%d) ServCpich(%d) set to ServHcsPrio(%d)
...
Line 1135: rrc_ServingCellSysInfoCache_AddIntraFNeighborHcsPrioInfoToSysInfoCache : ServUarfcn(%d) ServCpich(%d) NumNeibPrioInfoList(%d)
Line 1147: ServingCell Found at index(%d) Uarfcn(%d) Cpich(%d) IsServingHcsPrio(%d) HcsPrio(%d)
Line 1168: Add IntraNeighbor HCellPrioInfoIdx(%d) - Uarfcn(%d) Cpich(%d) HcsPrio(%d)
Line 1174: Invalid Info HCellPrioInfoIdx(%d) Uarfcn(%d) Cpich(%d) HcsPrio(%d)
Line 1181: Invalid Info NumNeibPrioInfoList(%d) NeibPrioInfoList(0X%x)
Line 1188: rrc_ServingCellSysInfoCache_AddIntraFNeighborHcsPrioInfoToSysInfoCache : ServUarfcn(%d) is not supported
Line 1197: rrc_ServingCellSysInfoCache_AddInterFNeighborHcsPrioInfoToSysInfoCache : ServUarfcn(%d) ServCpich(%d) NumNeibPrioInfoList(%d)
Line 1225: Add InterNeighbor HCellPrioInfoIdx(%d) - Uarfcn(%d) Cpich(%d) HcsPrio(%d)
Line 1231: Invalid Info HCellPrioInfoIdx(%d) Uarfcn(%d) Cpich(%d) HcsPrio(%d)
...
Line 1744: Critical :: Uarfcn and Cpich match up but Data is not available (Idx %d, Uarfcn %d, Cpich %d)
...
Line 1843: Cell Info is different (SysInfoContainer: uarfcn %d, cpich %d, ServingCell: uarfcn %d, cpich %d
...
Line 1905: ServCellPrio = %d, EutraReselPrio = %d
Line 1917: NW configure UTRA with highest priority
Line 1927: Get Bandwidth = %d, Priority = %d, QrxlevminEutra = %d, ThresXhigh = %d, ThresXlow = %d
Line 1933: Set Priority = %d
Line 1939: Set QrxlevminEutra = %d
Line 1945: Set ThreshXhigh = %d
Line 1951: Set ThreshXlow = %d
Line 1957: Set QqualminEutra = %d
Line 1963: Set ThreshXhigh2 = %d
Line 1969: Set ThreshXlow2 = %d
