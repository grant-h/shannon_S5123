Line 122: [DB] [ERROR]: File Name = %s : Line No =[%u]
Line 124: [DB] [ERROR]: DbIndex[%u] >= MAX_DB_INDEX
Line 130: [DB] [ERROR]: File Name = %s : Line No =[%u]
Line 132: [DB] [ERROR]: configDb_p[%u] is NULL 
Line 138: [DB] [ERROR]: File Name = %s : Line No =[%u]
Line 140: [DB] [ERROR]: DlSecondaryCellId[%u] >= MAX_SUPPORTED_DL_SECONDARY_CELLS
...
Line 1254: [DB Mgr] MsgDb ulDchToModifyBitmask: 0x%x, MsgDb ulPhyTrchToReleaseBitMask: 0x%x,  MsgDb ulDchToAddBitmask: 0x%x
Line 1297: [DB Mgr] MsgDb macConfRbReqBitMask: 0x%x, CfgDb rbIdPresentBitMask: 0x%x, MsgDb deletedRbIdBitMask: 0x%x 
...
Line 1775: [DB Mgr] DlSecondary Cell HSDPA (%d) was not configured before 
...
Line 2209: [DB Mgr] no ILMs to actually release, RollbackFlags RollbackRabm[%d],  RollbackCumac[%d], RollbackCuphy[%d] 
...
Line 3024: [DB Mgr] DB Commit: ulDchActuallyConfiguredInPhyBitMask 0x%x
Line 3085: [DB Mgr] DB Commit: dlDchActuallyConfiguredInPhyBitMask 0x%x
...
Line 4145: [DM Update] BandId(%d), Uarfcn(%d), PSC(%d), LAC(%d), RAC(%d)
Line 4196: [DM Update] cycle1(%d), cycle2(%d), InactivityThForCycle2(%d), cycle(%d), InactivityThForCycle(%d)
...
Line 5455: [DM Update] BandId(%d), Uarfcn(%d), PSC(%d), RAC(%d)
Line 5459: [DM Update] PLMN(%x%x%x%x%x%x)
