...
Line 695: [rrc_EutraMeasMapper_NotifyReport][EUTRA_EVENT] Earfcn %d Configured for MID %d
...
Line 806: [rrc_EutraMeasMapper_NotifyReport][EUTRA_PERIOD] Earfcn %d Configured for MID %d
...
Line 1198: [rrc_EutraMeasMapper_AddFreq]: Earfcn  %d :  MidBitmap = 0X%x
Line 1204: [rrc_EutraMeasMapper_AddFreq]: Freq TABLE FULL : Earfcn  %d NOT added
Line 1215: [rrc_EutraMeasMapper_AddFreq]:  Earfcn  %d : ++MID %d : MidBitmap = 0X%x
...
Line 1258: [rrc_EutraMeasMapper_RemoveFreq]: Earfcn %d still configured at UPHY:  MidBitmap = 0X%x
Line 1264: [rrc_EutraMeasMapper_RemoveFreq]: Earfcn %d is REMOVED from UPHY:  MidBitmap = 0X%x
...
Line 1296: [rrc_EutraMeasMapper_RemoveFreq]: REPLACED Earfcn %d is REMOVED from UPHY:  MidBitmap = 0X%x
Line 1307: [rrc_EutraMeasMapper_RemoveFreq]: Replaced Earfcn %d not configured in UPHY
Line 1315: [rrc_EutraMeasMapper_RemoveFreq]: Replaced Earfcn %d is REMOVED from UPHY:  MidBitmap = 0X%x
