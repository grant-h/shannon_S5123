...
Line 404: [Modify to Add] CellId[%d] ARFCN(%d), BSIC(Ncc: %d, Bcc: %d)
Line 412: [Modify to Remove] CellId[%d] ARFCN(%d), BSIC(Ncc: %d, Bcc: %d)
...
Line 691: [rrc_InterRMeasMapper_NotifyReport][GSM_EVENT] Cell id %d Configured for MID %d
...
Line 808: [rrc_InterRMeasMapper_NotifyReport][GSM_PERIOD] Cell id %d Configured for MID %d
...
Line 1189: [rrc_InterRMeasMapper_AddCell]: Cell ID %d : FrequencyBand %d BcchArfcn %d already present : Appended MID %d : MidBitmap = 0X%x
Line 1195: [rrc_InterRMeasMapper_AddCell]: Cell ID %d : FrequencyBand %d BcchArfcn  %d No Previous MIDs Configured!!
Line 1202: [rrc_InterFMeasMapper_AddCell]: Cell ID %d :BcchArfcn MISMATCH !! DB FrequencyBand %d BcchArfcn  %d  CIL FrequencyBand %d BcchArfcn %d
Line 1215: [rrc_InterFMeasMapper_AddCell]: Cell ID %d : FrequencyBand %d BcchArfcn  %d newly added :  MidBitmap = 0X%x
...
Line 1253: [rrc_InterRMeasMapper_RemoveCell]: FrequencyBand %d BcchArfcn %d still configured at UPHY:  MidBitmap = 0X%x
Line 1259: [rrc_InterRMeasMapper_RemoveCell]: FrequencyBand %d BcchArfcn %d is REMOVED from UPHY
Line 1279: [rrc_InterRMeasMapper_RemoveCell]:Cell Id %d -> Cell Id %d : FrequencyBand %d BcchArfcn %d is being REPLACED at UPHY
Line 1291: [rrc_InterRMeasMapper_RemoveCell]:Arcfn %d already Changed from Cell Id %d -> Cell Id %d
...
Line 1306: [rrc_InterRMeasMapper_RemoveCell]: Cell Id %d : MISMATCH!! : DB FrequencyBand %d BcchArfcn %d , CIL FrequencyBand %d BcchArfcn %d
...
Line 1341: [rrc_InterRMeasMapper_RemoveCell]: Cell Id %d : Cell Not Removed from UPHY : Old Cell already removed : DB(new) FrequencyBand %d BcchArfcn %d, CIL(old) FrequencyBand %d BcchArfcn %d
Line 1348: [rrc_InterRMeasMapper_RemoveCell]:  Cell Neither found in Cell Info List nor Measured for MID %d
Line 1361: [rrc_InterRMeasMapper_GetCellMidBitmap]: CellId %d MidBitmap = 0X%x
...
Line 1533: [rrc_InterRMeasMapper_UpdateCellInfoList] GsmCellId[%d] ARFCN(%d) BSIC(Ncc: %d, Bcc: %d) is already existed in InterRMeasMapperDB
Line 1540: [rrc_InterRMeasMapper_UpdateCellInfoList] updatedGsmCellsToAdd(%d) exceeded MAX(32)
Line 1553: [rrc_InterRMeasMapper_UpdateCellInfoList] GsmCellId[%d] ARFCN(%d) BSIC(Ncc: %d, Bcc: %d) is newly added
