...
Line 277: [rrc_InterFMeasMapper_TerminateMeasurement]:This MID(%d) is not configured in XIntraFMidBitMap(0x%x)
...
Line 583: [rrc_InterFMeasMapper_DoMeasurement]:  Before Filtering: REMOVE: uarfcn [%d] = %d, Cell[%d] = %d, Cpich%d 
...
Line 627: [rrc_InterFMeasMapper_DoMeasurement]:  Before Filtering: ADD: uarfcn [%d] = %d, Cell[%d] = %d,Cpich[FDD]%d 
...
Line 1091: [rrc_InterFMeasMapper_NotifyReport]: UARFCN(%d) has no Cells
Line 1113: [rrc_InterFMeasMapper_NotifyReport]: MID(%d) is not existed, so removed from DB
Line 1120: [rrc_InterFMeasMapper_NotifyReport]:	UARFCN %d Cell %d :  Included in MID %d
...
Line 1202: [rrc_InterFMeasMapper_NotifyReport]: WARNING!! NumOfCells exceeding the limit for UARFCN(%d)
...
Line 1239: [rrc_InterFMeasMapper_NotifyReport]: WARNING!! NumOfFreqs exceeding the limit for MID %d
Line 1282: [rrc_InterFMeasMapper_NotifyReport]: WARNING!! NumOfFreqs exceeding the limit for MID %d
...
Line 1573: rrc_InterFMeasMapper_DoTddMeasurementModify:Warning, CFM exist. No need to add Active Cell %d to Mapper for MID %d
Line 1580: rrc_InterFMeasMapper_DoTddMeasurementModify:Warning, Active Cell %d moved to MID %d
Line 1608: [rrc_InterFMeasMapper_AddCell]: Cell ID %d : Uarfcn %d PSC  %d already present : Appended MID %d : MidBitmap = 0X%x
Line 1614: [rrc_InterFMeasMapper_AddCell]: Cell ID %d : Uarfcn %d PSC  %d No Previous MIDs Configured!!
Line 1621: [rrc_InterFMeasMapper_AddCell]: Cell ID %d :PSC MISMATCH !! DB Uarfcn %d PSC  %d  CIL Uarfcn %d PSC %d
Line 1633: [rrc_InterFMeasMapper_AddCell]: Cell ID %d : Uarfcn %d PSC  %d newly added :	MidBitmap = 0X%x
...
Line 1670: [rrc_InterFMeasMapper_RemoveCell]: Uarfcn %d PSC %d still configured at UPHY:  MidBitmap = 0X%x
Line 1676: [rrc_InterFMeasMapper_RemoveCell]: Uarfcn %d PSC %d is REMOVED from UPHY
Line 1693: [rrc_InterFMeasMapper_RemoveCell]:Cell Id %d -> Cell Id %d : Uarfcn %d PSC %d is being REPLACED at UPHY
Line 1702: [rrc_InterFMeasMapper_RemoveCell]:PSC %d already Changed from Cell Id %d -> Cell Id %d
...
Line 1717: [rrc_InterFMeasMapper_RemoveCell]: Cell Id %d : PSC MISMATCH!! : DB Uarfcn %d PSC %d , CIL Uarfcn %d PSC %d
...
Line 1750: [rrc_InterFMeasMapper_RemoveCell]: Cell Id %d : Cell Not Removed from UPHY : Cell Already replaced: DB(new) Uarfcn %d PSC %d CIL(old) Uarfcn %d PSC %d
Line 1757: [rrc_InterFMeasMapper_RemoveCell]:  Cell Neither found in Cell Info List nor Measured for MID %d
Line 1776: [rrc_InterFMeasMapper_GetCellMidBitmap]: PSC %d MidBitmap = 0X%x
Line 1784: [rrc_InterFMeasMapper_GetCellMidBitmap]: Cell Id %d : PSC %d Not found in DB
Line 1789: [rrc_InterFMeasMapper_GetCellMidBitmap]: Cell Id %d : PSC MISMATCH!! DB: Uarfcn %d PSC %d, CIL Uarfcn %d PSC %d
...
Line 1999: [rrc_InterFMeasMapper_NotifyReport]: UARFCN(%d) has no Cells ERROR Returning No Processing Here
Line 2023: [rrc_InterFMeasMapper_NotifyReport]: MID(%d) is not existed, so removed from DB
Line 2029: [rrc_InterFMeasMapper_NotifyReport]:  UARFCN %d Cell %d :  Included in MID %d
...
Line 2152: [rrc_InterFMeasMapper_NotifyReport]: WARNING!! NumOfFreqs exceeding the limit for MID %d
Line 2202: [rrc_InterFMeasMapper_NotifyReport]: Serving Cell found uarfcn =%d, cell param ID == %d
...
Line 2270: [rrc_InterFMeasMapper_NotifyReport]:  UARFCN %d Cell %d :  Included in MID %d
Line 2295: [rrc_InterFMeasMapper_UpdateIntraFreqMeasInd] INFO: 
Line 2323: [rrc_InterFMeasMapper_NotifyReport]: WARNING!! NumOfFreqs exceeding the limit for MID %d
Line 2346: rrc_InterFMeasMapper_NotifyReportTDD : Inst Id is NULL !!
Line 2367: SCell meas[DCH][L3FLT] UARFCN: %d, Cell_Id: %d, CellParamId: %d, Rscp: %i dBm, D-Rscp:%d
...
Line 2623: N-freq Serving Cells, RSCP = %d, CellParamId = %d
