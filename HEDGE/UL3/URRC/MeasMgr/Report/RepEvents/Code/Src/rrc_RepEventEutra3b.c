...
Line 351: [H_3b] is = %d
Line 363: [NotifyReport] EutraMeasInd Earfcn(%d), CellId(%d), RSRP(%d), RSRQ(%d)
Line 396: [rrc_RepEventEutra3b_NotifyReport] Event3C already triggered on CellId(%d) Earfcn(%d) so Event3B might be evaluated.
Line 405: rrc_RepEventEutra3b::NotifyReport	[NON FATAL ERROR] - NumTriggered > (Asn_maxNumEUTRAFreqs * MaxEutraCellsMeas).
Line 422: [rrc_RepEventEutra3b_NotifyReport] Event3C NOT triggered on CellId(%d) Earfcn(%d) so Event3B won't be evaluated.
Line 434: [rrc_RepEventEutra3b_NotifyReport] Eq1 satisfied [Earfcn: %d CellID: %d] [rsrp] LHS*100(%d) <= RHS*100(%d)
Line 445: [rrc_RepEventEutra3b_NotifyReport] Eq1 satisfied [Earfcn: %d CellID: %d] [rsrq] LHS*100(%d) <= RHS*100(%d)
Line 465: [TTT(%dms) Started] Earfcn(%d), CellId(%d)
Line 472: [rrc_RepEventEutra3bNotifyReport] No of TTT exceeding 32. Needs extension
Line 488: rrc_RepEventEutra3b::NotifyReport Dont Trigger Event 3b for the  Earfcn(%d) Cell (%d) is not already triggerd for 3c.
Line 494: [rrc_RepEventEutra3b_NotifyReport] Cell ID: %d Earfcn %d already present in TRIGGERED 3B EVENT
Line 500: [rrc_RepEventEutra3b_NotifyReport] Dont Trigger Event 3b for the Cell ID: %d Earfcn %d is Barred.
Line 528: [rrc_RepEventEutra3b_NotifyReport] Eq2 satisfied [Earfcn: %d CellID: %d] [rsrp] LHS*100(%d) > RHS*100(%d)
Line 545: [rrc_RepEventEutra3b_NotifyReport] Eq2 satisfied [Earfcn: %d CellID: %d] [rsrq] LHS*100(%d) > RHS*100(%d)
