...
Line 543: [rrc_IntraFRep_SetupMeasResultsArr] ++TmpMonSetResults[%d] = %d
Line 657: [rrc_IntraFRep_SetupMeasResultsArr] ++TmpDetSetResults[%d] = %d
...
Line 918: [rrc_IntraFRep_SetupMeasResultsArr] MID(%d) MaxNumberOfReportingCells(%d) NumCellsInCellResultsArray(%d)
...
Line 1259: MID[%d] Deleted IntraFreqMeasInd(0x%X)
...
Line 1447: [rrc_IntraFRep_SetAdditionalMeasRep]ActiveSetCell PSC (%d) is not measured/syncronized so discarded
Line 1467: [rrc_IntraFRep_SetAdditionalMeasRep]MonitoredSetCell PSC (%d) is not measured/syncronized so discarded
Line 1487: [rrc_IntraFRep_SetAdditionalMeasRep]DetectedSetCellResults PSC (%d) is not measured/syncronized so discarded
Line 1514: [rrc_IntraFRep_SetAdditionalMeasRep]ActiveSetCell PSC (%d) is not measured/syncronized so discarded
...
Line 1989: The 1st MeasInd of MID(%d)-IntraFreq Periodic Measurement, PrevValue will be used by FirstConfiguredMid(%d)
Line 2054: FirstConfiguredMid(%d) MeasInd is NULL
Line 2086: [NotifyMonitoredSetRemoval]:MID %d : PrevMeasEcNo = %d: Mon -> Det set[%d] = PSC %d
...
Line 2138: [NotifyMonitoredSetRemoval] Wrong IntraF Report client Inst: [%x]
...
Line 2184: [NotifyDetectedToMonitoredChange] Wrong IntraF Report client Inst: [%x]
...
Line 2833: [rrc_IntraFRep_SetupMeasResultsArr] MID(%d) MaxNumberOfReportingCells(%d) NumCellsInCellResultsArray(%d)
...
Line 3146: MID[%d] Deleted IntraFreqMeasInd(0x%X)
