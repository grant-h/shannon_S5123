...
Line 902: rrc_iePhErucchInfo_processIeImpl:tRucch = %d,nRucch = %d,twait = %d,tSi = %d,extEstWindow = %d
Line 904: rrc_iePhErucchInfo_processIeImpl:NumOfASC = %d
Line 914: rrc_iePhErucchInfo_processIeImpl:E_Ruch_ASC[%d]: availableSYNC_UlCodesIndics =%d,subchannelsize = %d,subchannels= %d
Line 919: Error: IEPhErucchInfo_p->numOfASC  = %d
Line 923: rrc_iePhErucchInfo_processIeImpl:NumOfASCpersist = %d
Line 929: rrc_iePhErucchInfo_processIeImpl: E_RUCCH_PersistenceScalingFactor[%d] = %d
Line 936: Error: IEPhErucchInfo_p->numOfASCpersist  = %d
Line 940: rrc_iePhErucchInfo_processIeImpl:isSyncULInfo = %d
Line 946: rrc_iePhErucchInfo_processIeImpl:prxUpPCHdes = %d,powerRampStep = %d,maxSynUlTx = %d,mmax = %d,syncULCodesBmp = %d
Line 952: rrc_iePhErucchInfo_processIeImpl:isprachInfo = %d
Line 956: rrc_iePhErucchInfo_processIeImpl:NumPrachInfo = %d
Line 964: rrc_iePhErucchInfo_processIeImpl:prachInfo[%d] timeSlotNum = %d,prachCClistSize = %d,midAllocMode = %d,midamConf = %d,midamShift = %d,isFpachInfo = %d
Line 969: rrc_iePhErucchInfo_processIeImpl:prach_ChanCodes[%d] = %d
Line 980: rrc_iePhErucchInfo_processIeImpl:NumPRACH_FPACH = %d
