...
Line 460: DLIntegrityProt_p->CountI and RxMsn in rrc_DLIntegrityProt_PerformDLIntegrityCheck %x %x 
...
Line 523: CountI = %x, MAC = %x, Fresh = %x, EncodedMsgSize = %d, Associated RB-ID = %d
Line 524: IKUsed = 
...
Line 553: CountI = %x, MAC = %x, Fresh = %x, EncodedMsgSize = %d, Associated RB-ID = %d
Line 559: Integrity check failed, Rx-MAC: %x differs to MAC:%x
Line 561: CountI = %x, Fresh = %x, EncodedMsgSize = %d, Associated RB-ID = %d
Line 562: IKUsed = 
...
Line 597: CountI = %x, Fresh = %x, EncodedMsgSize = %d, Associated RB-ID = %d
Line 598: IKUsed = 
...
Line 649: CountI = %x, Fresh = %x, EncodedMsgSize = %d, Associated RB-ID = %d
...
Line 683: CountI = %x, Fresh = %x, EncodedMsgSize = %d, Associated RB-ID = %d
...
Line 719: CountI = %x, Fresh = %x, EncodedMsgSize = %d, Associated RB-ID = %d
...
Line 757: CountI = %x, Fresh = %x, EncodedMsgSize = %d, Associated RB-ID = %d
...
Line 818: CountI = %x, MAC = %x, Fresh = %x, EncodedMsgSize = %d, Associated RB-ID = %d
Line 819: IKUsed = 
Line 823: ReconfigAborted: Retrial without HFN increment
Line 846: DLIntProt  F9 class failed to perform DLIntCheck
Line 853: CountI = %x, MAC = %x, Fresh = %x, EncodedMsgSize = %d, Associated RB-ID = %d
Line 854: IKUsed = 
...
Line 939: CountI = %x, Fresh = %x, EncodedMsgSize = %d, Associated RB-ID = %d
...
Line 963: CountI = %x, Fresh = %x, EncodedMsgSize = %d, Associated RB-ID = %d
...
Line 1024: CountI = %x, Fresh = %x, EncodedMsgSize = %d, Associated RB-ID = %d
...
Line 1048: CountI = %x, Fresh = %x, EncodedMsgSize = %d, Associated RB-ID = %d
Line 1094: Same as previous message,discarded for duplicate
Line 1140: DSDS: DlInt MSN Wrap Around success ( RxMsn >= Previous MSN), update the COUNTI[SRB %d] = %x 
