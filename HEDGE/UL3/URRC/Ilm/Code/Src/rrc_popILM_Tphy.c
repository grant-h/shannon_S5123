...
Line 188:  [rrc_CTPHYSibsSchdInfoInd_Create] SIB Type = %d, 
...
Line 278:  [rrc_CTPHYSibsSchdInfoInd_Create] Rep type = %d, 
Line 285:  [rrc_CTPHYSibsSchdInfoInd_Create] rep_info = %d, 
Line 306:  [rrc_CTPHYSibsSchdInfoInd_Create] rep_info = %d, 
Line 315:  [rrc_CTPHYSibsSchdInfoInd_Create] segCount = %d, 
Line 336: [URRC BCH in DCH]  rrc_CUPHY_BCHResRel_REQ_setParams: IsDCH = %d
Line 565:  rrc_DbPopIlm_CTPHYEDCHConfigREQMsg phyActTm = %d, Changed to Now As Cell Update Cnf Received
...
Line 848:  TphyDedicatedModeConfigReqMsg phyActTm = %d, MsgDbIndex = %d
Line 871: RL type is %d
Line 883: numCCTrCHtoAdd %d: outside the function 
Line 896: DB PopILM(before): trchToAddBitmask 0x%x
Line 903: DB PopILM(After): trchToAddBitmask 0x%x, dlDchIdPresentBitMask 0x%x, availableDlDchInMuxOptBitMask 0x%x
Line 951:  TphyDedicatedModeConfigReqMsg dedModeDlInfo_p->numDlCctrch = %d
Line 970:  TphyDedicatedModeConfigReqMsg dedModeDlInfo_p->numDlCctrch = %d and DlTfcs is Invliad
Line 982: DB PopILM: dlDchActuallyConfiguredInPhyBitMask 0x%x
Line 1049:  ulDpchInfo_p->uppchPositionInfo= %d
Line 1101: DB PopILM: ulDchActuallyConfiguredInPhyBitMask 0x%x
...
Line 1663: DedicatedModeReleaseReq: isActivationTime: %d activationTime %d
Line 1707: rrc_DbPopIlm_TphyHsdschResourcesConfigReqMsg Baton HHO setting Activation as Now
Line 1720:  rrc_DbPopIlm_TphyHsdschResourcesConfigReqMsg phyActTm = %d, Changed to Now As Cell Update Cnf Received
...
Line 1767: rrc_priv_IeRbAndTfsCrossValidator_Hsdpa_setCtphyHsdschConfigReq: HssichInfo.timeSlotNum = %d, HssichInfo.channelisationCode = %d
Line 1771: rrc_priv_IeRbAndTfsCrossValidator_Hsdpa_setCtphyHsdschConfigReq: HssichInfo.midambleConfiguration= %d
...
Line 2093: channelCoding=[%d] , rateMatchingArgument[%d], crcSize = %d, codingRate = %d
Line 2102: numOfTfTableEntries[%d]
Line 2117:  dbDynInfo_p->rlcSize=[%d],macHdrSz=[%d]
Line 2118:  dbDynInfo_p->numofTBCount=[%d]
Line 2128: tfi=[%d],tBlockSize =%d ,numOTblocks =%d,
...
Line 2304:  rrc_DbPopIlm_TphyUlDpchPowerOffsetInfoSetParams numCCtrChCtfc = %d
Line 2354:  rrc_DbPopIlm_TphyUlPwrOffInfoAddOrReconfSetParams : TFCS_ID = %d
Line 2461: .imsi[%d] = %d
Line 2498: .imsiLength  = %d
Line 2506: .BodyPtr->drxCycleInfo.imsi = %d
Line 2648: numOfTfTableEntries=[%d],TrChType[%d]
Line 2745: PichInfo.ChannelisationCodeList[0] = %d  ,PichInfo.ChannelisationCodeList[1] = %d
