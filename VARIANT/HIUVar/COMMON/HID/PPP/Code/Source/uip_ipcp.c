Line 109: ipcp_up(): Bad local IP address [%d:%d:%d:%d].
...
Line 372: ipcp_frame_read()  Code [%d], ID [%d] GIPCP->itsState %d
...
Line 472: ipcp_reply_CfRq_action(): Peer Requested IP Address [%d:%d:%d:%d].
Line 478: ipcp_reply_CfRq_action(): Peer IP address rejected.
Line 488: ipcp_reply_CfRq_action(): Peer IP address NAKed with  [%d:%d:%d:%d].
