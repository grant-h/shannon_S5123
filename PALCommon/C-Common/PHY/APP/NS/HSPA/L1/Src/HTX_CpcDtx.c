...
Line 1477: CPC::: current_cfn = %d, current_slot = %d, applied_slot = %d
Line 1478: CPC::: Pattern = %d bDPCCH_C=0x%x, bDPCCH_D=0x%x, bDPCCH_Q=0x%x, bDPCCH_A=0x%x, CPC_DTX_REG = %d
Line 1506: CPC::: m_iInactCnt = %d m_iInactCntAfter = %d, m_iCycleValue = %d m_iCycleValueAfter = %d m_iCycleBefore_ES = %d m_bPattern_Hit_ES = %d, bPattern_Hit = %d
Line 1605: CPC::: preamble_length = %d
Line 1606: CPC::: cur_slot = %d frame = %d, subframe = %d edch_on = %d m_EDCH_Pattern_DSP = 0x%x
Line 2022: CPC ::: [CFN = %d, Subframe = %d] m_iCycleValue = %d, m_iCycleBefore = %d m_iInactCnt = %d m_bLongPreEn = %d
Line 2024: CPC ::: reg_cqi_en_M = %d, reg_cqi_rpt_M = %d Edch_ON = %d CQI_PRIORITY = %d CQI_DTX_TIMER = %d
Line 2042: DtxActive_Flag = %d, UL_DTX_Active_Cfn = %d m_bDTXOn_DSP = %d m_bHSDTXOn_DSP = %d
